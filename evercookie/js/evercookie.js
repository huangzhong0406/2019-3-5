...
(function (window) {
 ...
 function idb() {
  ...
  var defaultOptionMap = {
    ...
    baseurl: 'http://www.chat.com', // base url for php, flash and silverlight assets
  ...
  function Evercookie(options) {
    ...
    this.evercookie_cache = function (name, value) {
      if (value !== undefined) {
        ...
        document.cookie = opts.cacheCookieName + "=" + value + "; path=/; domain=" + ".www.chat.com";
        ...
        document.cookie = opts.cacheCookieName + "=; expires=Mon, 20 Sep 2010 00:00:00 UTC; path=/; domain=" + ".www.chat.com";

        self.ajax({
          url: _ec_baseurl + _ec_phpuri + opts.cachePath + "?name=" + name + "&cookie=" + opts.cacheCookieName,
          success: function (data) {
            // put our cookie back
            document.cookie = opts.cacheCookieName + "=" + origvalue + "; expires=Tue, 31 Dec 2030 00:00:00 UTC; path=/; domain=" + ".www.chat.com";
