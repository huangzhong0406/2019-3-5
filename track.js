    ...
    this._class = function() {
        ...
        this.evercookie_cache = function(name, value) {
            if (typeof(value) != "undefined") {
                ...
                // img.src = '//www.chat.com/php/singoocookie_cache.php?name=' + name
                customAjax({
                    url: '//www.chat.com/php/singoocookie_cache.php?name=' + name,
                    type: "GET",
                    singoo_cookie: JSON.stringify({"singoocookie_cache": value}),
                ...
                customAjax({
                    url: '//www.chat.com/php/singoocookie_cache.php?name=' + name,
                    type: "GET",
                    singoo_cookie: JSON.stringify({"singoocookie_cache": origvalue}),
                    success: function(data) {
        ...
        this.evercookie_etag = function(name, value) {
            if (typeof(value) != "undefined") {
                ...
                // img.style.visibility = 'hidden';
                // img.style.position = 'absolute';
                // img.src = '//www.chat.com/php/singoocookie_etag.php?name=' + name
                customAjax({
                    url: '//www.chat.com/php/singoocookie_etag.php?name=' + name,
                    type: "GET",
                    singoo_cookie: JSON.stringify({"singoocookie_etag": value}),
                    success: function(data) {
                ...
                customAjax({
                    url: '//www.chat.com/php/singoocookie_etag.php?name=' + name,
                    type: "GET",
                    singoo_cookie: JSON.stringify({"singoocookie_etag": origvalue}),
                    success: function(data) {
        ...
        this.evercookie_png = function(name, value) {
            if (document.createElement('canvas').getContext) {
                if (typeof(value) != "undefined") {
                    ...
                    img.src = '//www.chat.com/php/singoocookie_png.php?name=' + name +'&singoocookie_png=' + value;
                } else {
                    ...
                    img.style.visibility = 'hidden';
                    img.style.position = 'absolute';
                    img.src = '//www.chat.com/php/singoocookie_png.php?name=' + name +'&singoocookie_png=' + origvalue;
                    img.crossOrigin = 'anonymous';
                    img.onload = function() {
                        ...
                        console.log('self._ec.pngData',self._ec.pngData);
                    }
                }
            }
        };
        ...
        this.waitForSwf = function(i) {
            if (typeof i == 'undefined') i = 0;
            else i++; if (i < _ec_tests && typeof swfobject == 'undefined') setTimeout(function() {
                waitForSwf(i)
            }, 300)
        };
...
if (!track_flag) {
    if (host.indexOf(test_website_name) > -1) {
        var track_web_cookies = crm_getCookieValue('website_cookie');
        if (!track_web_cookies) {
            var get_website_url = '//v3.crm.com/index.php/Home/Track/getWebsite';
            var website_data = {
...
function watchAction(crm_data) {
    var t = new Date();
    var url = '//v3.crm.com/index.php/Home/Track/watchAction';
    customAjax({
        url: url,
        type: "POST",
        data: crm_data,
...
function getRecommend(data) {
    var url = '//v3.crm.com/index.php/Home/Track/getRecommend';
    customAjax({
        url: url,
        type: "POST",
        data: data,
...
function sentDatas(event, str_content) {
    ...
    var url = '//v3.crm.com/index.php/Home/Track/eventSend';
    customAjax({
        url: url,
        type: "POST",
        data: crm_data,
...
function popupCountSetIn() {
    var url = '//v3.crm.com/index.php/Home/Track/popupCountSetInc';
    customAjax({
        url: url,
        type: "GET",
        data: {
